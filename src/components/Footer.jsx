    ...
    <footer className="relative pt-24 pb-12 overflow-hidden bg-white">
      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
          ...
          {/* Contact Info — Compact Professional Card */}
          <div className="bg-white border border-primary-100 p-7 rounded-[1.5rem] shadow-sm relative overflow-hidden h-fit self-start">
            <h4 className="text-primary-900 font-extrabold text-[10px] uppercase tracking-[0.2em] mb-7 ml-1">Reach Out</h4>
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-[9px] font-black text-primary-600 uppercase tracking-widest mb-0.5">Email Support</p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-[9px] font-black text-emerald-600 uppercase tracking-widest mb-0.5">Status</p>
                  <p className="text-sm font-bold text-primary-900">RBI Regulated</p>
                </div>
              </div>
            </div>
          </div>
